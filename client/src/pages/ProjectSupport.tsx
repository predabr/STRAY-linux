      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-8 grid gap-5 lg:grid-cols-[1.2fr_.8fr]">
          <div className="rounded-3xl border border-border bg-card p-6 shadow-sm sm:p-9">
            ...
            <p className="mt-6 max-w-xl text-sm leading-7 text-muted-foreground">O apoio é opcional e não desbloqueia recursos. Quando o canal estiver disponível, a contribuição abrirá somente o checkout hospedado de um provedor autorizado. O aplicativo não exibirá chaves Pix, CPF, dados bancários nem processará pagamentos diretamente.</p>
          ...
          <aside className="rounded-3xl border border-primary/25 bg-primary/[.06] p-6 sm:p-8">
            ...
            <h2 className="mt-3 text-2xl font-semibold tracking-[-.04em]">Canal ainda indisponível</h2>
            <p className="mt-3 text-sm leading-6 text-muted-foreground">A ativação depende de uma conta recebedora verificada e de credenciais do provedor. Até isso ocorrer, não há link de pagamento, QR dinâmico, coleta de dados financeiros ou redirecionamento.</p>
