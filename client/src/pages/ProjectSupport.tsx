      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-8 grid gap-5 lg:grid-cols-[1.2fr_.8fr]">
          <div className="rounded-3xl border border-border bg-card p-6 shadow-sm sm:p-9">
            ...
            <GithubProjectQr className="mt-6 max-w-xl" tone="light" />
            <div className="mt-4 max-w-xl"><PixContributionPanel tone="light" /></div>
          </div>
          <aside className="rounded-3xl border border-primary/25 bg-primary/[.06] p-6 sm:p-8">
            ...
            <div className="mt-6 space-y-3 rounded-2xl border border-border bg-background/80 p-4 text-sm">
              ...
              <div className="flex gap-3"><LockKeyhole className="mt-0.5 h-4 w-4 shrink-0 text-primary" /><span>Nenhuma chave Pix, identificador pessoal, token ou dado bancário é publicado nesta tela.</span></div>
            </div>
          </aside>
        </section>
      </div>
