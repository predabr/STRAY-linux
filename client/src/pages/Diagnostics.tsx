...
import { getDiagnosticEvidenceGaps } from "@/lib/diagnosticEvidence";
import { trpc } from "@/lib/trpc";
import { assessLinuxGamingEnvironment, type LinuxHealthFinding } from "../../../shared/linuxHealth";
import { scannerReportInput, type ScannerReport } from "../../../shared/scannerReport";
import { Activity, AlertTriangle, CheckCircle2, DatabaseBackup, Download, FileSearch, PackageSearch, RefreshCw, ScanLine, ShieldCheck, Wrench } from "lucide-react";
import { useState } from "react";
import { Link } from "wouter";

type MaintenanceCategory = { id: string; label: string; items: string[]; sizeMb?: number | null; command: string; note: string };
type MaintenancePreviewData = { family: string; manager: string | null; generatedAt: string; privilege: { elevated: boolean; cleanupRequiresConfirmation: true }; warning: string; categories: MaintenanceCategory[] };
...
export default function Diagnostics() {
  ...
  const [maintenance, setMaintenance] = useState<MaintenancePreviewData | null>(null);
