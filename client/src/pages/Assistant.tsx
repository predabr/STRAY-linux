...
export default function AssistantPage() {
  ...
  const send = async (question: string) => {
    ...
    try {
      ...
      await saveLocal.mutateAsync({ question, answer, citations: localCitations });
    } catch (error) {
