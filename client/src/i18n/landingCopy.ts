...
const landingCopySource: Record<Locale, LandingCopy> = {
  ...
  en: {
    ...
    downloadsEyebrow: "VERIFIABLE DOWNLOADS / V1.3.0", downloadsLead: "Choose the right family. The complete command downloads the package, verifies its checksum and installs only that format.", downloadsMain: "Ready for", downloadsAccent: "your machine.", uninstallLead: "Already installed it? See the uninstaller by platform.",
  ...
  es: {
    ...
    downloadsEyebrow: "DESCARGAS VERIFICABLES / V1.3.0", downloadsLead: "Elige la familia correcta. El comando descarga el paquete, verifica el checksum e instala solo ese formato.", downloadsMain: "Listo para", downloadsAccent: "tu máquina.", uninstallLead: "¿Ya instalaste la aplicación? Consulta el desinstalador por plataforma.",
  ...
  it: {
    ...
    downloadsEyebrow: "DOWNLOAD VERIFICABILI / V1.3.0", downloadsLead: "Scegli la famiglia corretta. Il comando scarica il pacchetto, verifica il checksum e installa solo quel formato.", downloadsMain: "Pronto per", downloadsAccent: "la tua macchina.", uninstallLead: "Hai già installato l’app? Vedi la disinstallazione per piattaforma.",
  ...
  ru: {
    ...
    downloadsEyebrow: "ПРОВЕРЯЕМЫЕ ЗАГРУЗКИ / V1.3.0", downloadsLead: "Выберите правильное семейство. Команда скачивает пакет, проверяет checksum и устанавливает только этот формат.", downloadsMain: "Готово для", downloadsAccent: "вашей машины.", uninstallLead: "Уже установили? Смотрите удаление по платформам.",
  ...
  "zh-CN": {
    ...
    downloadsEyebrow: "可验证下载 / V1.3.0", downloadsLead: "选择正确的发行版家族。命令会下载软件包、验证校验和并仅安装该格式。", downloadsMain: "为你的", downloadsAccent: "设备准备就绪。", uninstallLead: "已安装应用？查看各平台卸载说明。",
  ...
  ja: {
    ...
    downloadsEyebrow: "検証可能なダウンロード / V1.3.0", downloadsLead: "正しいファミリーを選択してください。コマンドはパッケージを取得し、チェックサムを検証してその形式だけをインストールします。", downloadsMain: "あなたの", downloadsAccent: "マシンへ。", uninstallLead: "すでにインストール済みですか？プラットフォーム別の削除手順を確認してください。",
  ...
  ko: {
    ...
    downloadsEyebrow: "검증 가능한 다운로드 / V1.3.0", downloadsLead: "올바른 계열을 선택하세요. 명령은 패키지를 받고 체크섬을 확인한 뒤 해당 형식만 설치합니다.", downloadsMain: "내", downloadsAccent: "장비를 위해 준비됨.", uninstallLead: "이미 설치했나요? 플랫폼별 제거 방법을 확인하세요.",
  ...
  ar: {
    ...
    downloadsEyebrow: "تنزيلات قابلة للتحقق / V1.3.0", downloadsLead: "اختر العائلة الصحيحة. ينزّل الأمر الحزمة ويتحقق من المجموع ويثبت هذا التنسيق فقط.", downloadsMain: "جاهز", downloadsAccent: "لجهازك.", uninstallLead: "هل ثبّت التطبيق بالفعل؟ راجع إزالة التثبيت حسب المنصة.",
...
const currentPublicRelease = "1.3.0";
