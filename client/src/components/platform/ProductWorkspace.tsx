...
export function ProductWorkspace({ children }: { children: ReactNode }) {
  ...
  const workspace: WorkspaceNavigationItem[] = [{ href: "/dashboard", label: t("overview"), icon: LayoutDashboard }, { href: "/games", label: t("gameHub"), icon: Gamepad2 }, { href: "/library", label: t("installedGames"), icon: Library }, { href: "/linuxfix", label: t("linuxFix"), icon: Wrench }, { href: "/assistant", label: copy.assistant, icon: BotMessageSquare }];
  const system: WorkspaceNavigationItem[] = [{ href: "/dashboard/pc", label: copy.systemInformation, icon: MonitorCog }, { href: "/scanner", label: t("scanner"), icon: ShieldCheck }, { href: "/diagnostics", label: copy.diagnostics, icon: Activity }, { href: "/performance", label: copy.performance, icon: Activity }];
  const advancedTools: WorkspaceNavigationItem[] = [{ href: "/mods", label: copy.mods, icon: Boxes }, { href: "/compare", label: copy.compare, icon: BarChart3 }, { href: "/benchmark", label: t("benchmark"), icon: Gauge }, { href: "/roadmap", label: roadmapCopy[locale].nav, icon: Network }, { href: "/setup", label: t("setup"), icon: BookOpenCheck }, { href: "/snapshots", label: copy.snapshots, icon: Camera }, { href: "/system-graph", label: copy.systemMap, icon: Network }, { href: "/system-timeline", label: copy.timeline, icon: Activity }, { href: "/preflight", label: copy.preflight, icon: ShieldCheck }, { href: "/regression", label: copy.regression, icon: Gauge }, { href: "/recovery", label: copy.recovery, icon: ShieldCheck }, { href: "/logs", label: copy.logs, icon: Activity }, { href: "/notifications", label: copy.alerts, icon: Activity }, { href: "/controllers", label: copy.controllers, icon: Gamepad2 }];
  const personal: WorkspaceNavigationItem[] = [{ href: "/dashboard/activity", label: copy.localActivity, icon: Activity }, { href: "/project-support", label: copy.supportProject, icon: HeartHandshake }, { href: "/settings", label: t("settings"), icon: Settings }];
