...
export function ProductWorkspace({ children }: { children: ReactNode }) {
  ...
  const advancedTools: WorkspaceNavigationItem[] = [{ href: "/mods", label: "Mods", icon: Boxes }, { href: "/compare", label: copy.compare, icon: BarChart3 }, { href: "/benchmark", label: t("benchmark"), icon: Gauge }, { href: "/setup", label: t("setup"), icon: BookOpenCheck }, { href: "/snapshots", label: "Snapshots", icon: Camera }, { href: "/system-graph", label: "Mapa do sistema", icon: Network }, { href: "/system-timeline", label: "Linha do tempo", icon: Activity }, { href: "/preflight", label: "Pré-voo", icon: ShieldCheck }, { href: "/regression", label: "Regressão", icon: Gauge }, { href: "/recovery", label: "Recuperação", icon: ShieldCheck }, { href: "/logs", label: "Logs", icon: Activity }, { href: "/notifications", label: "Alertas", icon: Activity }, { href: "/controllers", label: "Controles", icon: Gamepad2 }];
