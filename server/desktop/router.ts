...
function desktopAiAnswer(question: string) {
  if (!isStrayAiDomainQuestion(question)) return { answer: STRAY_AI_OUT_OF_SCOPE_RESPONSE, citations: [], explanation: { facts: [], inferences: [], estimates: [], unknowns: ["O pedido está fora do escopo do Stray AI."], why: { internalSources: 0, profileUsed: false, memoryUsed: false, confidence: "unavailable" as const } }, context: { inScope: false, profileAvailable: false, internalSources: 0, memoryUsed: false } };
