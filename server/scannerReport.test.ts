...
describe("contrato do stray-scan", () => {
  ...
  it("aceita ambiente, armazenamento e monitores opcionais sem ampliar dados pessoais", () => {
    ...
    expect(parsed.system.privileges).toEqual({ elevated: false, mode: "standard" });
